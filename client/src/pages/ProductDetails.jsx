  ...
  return (
    <RootLayout>
      <div className="bg-gray-50 min-h-screen">
        ...
        {/* Share - Mobile position */}
        {!isDesktop && (
          <div
            className="bg-white mt-2 p-4 flex items-center gap-2 max-w-7xl mx-auto"
            data-aos="fade-up"
            data-aos-delay="500"
          >
            <div className="text-gray-600">Chia sẻ:</div>
            <div className="flex gap-1">
              <IconButton size="small" className="bg-blue-800 text-white">
                <span className="text-xs">f</span>
              </IconButton>
              <IconButton size="small" className="bg-blue-500 text-white">
                <span className="text-xs">m</span>
              </IconButton>
              <IconButton size="small" className="bg-blue-400 text-white">
                <span className="text-xs">t</span>
              </IconButton>
              <IconButton size="small" className="bg-red-600 text-white">
                <span className="text-xs">p</span>
              </IconButton>
              <IconButton size="small" className="bg-gray-500 text-white">
                ...
                >
                  ...
                  <div className="p-3">
                    <h3 className="font-medium text-sm line-clamp-2 h-10">
                      Đệm Ngồi Ghế Thư Giãn Cotton NELLY - Màu Khác
                    </h3>
                    <div className="mt-2 flex items-center justify-between">
                      <div className="text-red-600 font-bold">89,000₫</div>
