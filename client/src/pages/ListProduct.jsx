...
// Filter categories
const categories = [
  { id: "recent", name: "Được mua nhiều gần đây" },
  { id: "new", name: "Sản phẩm mới" },
  { id: "all", name: "Tất cả sản phẩm" },
]

const brands = ["XYLIA", "XING", "SUSANA", "Dark Mint", "RING"]

const priceRanges = [
  { id: "under1m", name: "Dưới 1.000.000₫" },
  { id: "1m-2m", name: "1.000.000₫ - 2.000.000₫" },
  { id: "2m-3m", name: "2.000.000₫ - 3.000.000₫" },
  { id: "3m-4m", name: "3.000.000₫ - 4.000.000₫" },
  { id: "over4m", name: "Trên 4.000.000₫" },
]
...
const ListProduct = () => {
  ...
  // Animation delay for staggered product cards
  ...
  return (
    <RootLayout>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <IconButton
                 sx={{
                  display: {
                    xs: 'block',  // hiển thị ở kích thước nhỏ
                    md: 'none',   // ẩn từ md trở lên
                  },
                  mr: 2,          // margin-right = 0.5 * 8px = 16px
                }}
            ...
            <div className="flex items-center gap-2">
              <span className="text-gray-600 hidden md:inline-block" data-aos="fade-left" data-aos-delay="300">
      ...
      <div className="flex flex-1">
        ...
        <Drawer anchor="left" open={sidebarOpen} onClose={toggleSidebar} className="md:hidden">
          <div className="w-72">
            ...
            <div className="p-4 overflow-y-auto h-[calc(100vh-60px)]">
              ...
              <div className="mb-6" data-aos="fade-right" data-aos-delay="200">
                ...
                <div
                  className={`ml-2 overflow-hidden transition-all duration-300 ${brandOpen ? "max-h-96" : "max-h-0"}`}
                >
              ...
              <div className="mb-6" data-aos="fade-right" data-aos-delay="300">
                ...
                >
                  ...
                  {priceOpen ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
                </div>
                <div
                  className={`ml-2 overflow-hidden transition-all duration-300 ${priceOpen ? "max-h-96" : "max-h-0"}`}
                >
                  <FormGroup className="ml-2">
              ...
              <div className="mt-6" data-aos="fade-up" data-aos-delay="400">
                <Button variant="contained" fullWidth className="bg-rose-600 hover:bg-rose-700" onClick={toggleSidebar}>
                  Áp dụng bộ lọc
                </Button>
              </div>
            </div>
        ...
        >
          ...
          <div className="mb-6">
            ...
            >
              {categories.map((category, index) => (
                <div
                  key={category.id}
                  className="text-gray-700 hover:text-rose-600 cursor-pointer py-1"
                  data-aos="fade-left"
          ...
          <div className="mb-6">
            ...
            <div className={`ml-2 overflow-hidden transition-all duration-300 ${brandOpen ? "max-h-96" : "max-h-0"}`}>
              <FormGroup className="ml-2">
                {brands.map((brand, index) => (
                  <FormControlLabel
                    key={brand}
          ...
          <div className="mb-6">
            ...
            <div className={`ml-2 overflow-hidden transition-all duration-300 ${priceOpen ? "max-h-96" : "max-h-0"}`}>
              <FormGroup className="ml-2">
                {priceRanges.map((range, index) => (
                  <FormControlLabel
                    key={range.id}
              ...
              >
                <div className="relative">
                  ...
                  <IconButton
                    ...
                    size="small"
                    data-aos="zoom-in"
                    data-aos-delay={getAnimationDelay(index) + 300}
                  >
                    <Favorite fontSize="small" className="text-gray-400 hover:text-rose-500" />
                  </IconButton>
                </div>
                <div className="p-3">
                  <div
                    ...
                    data-aos="fade-right"
                    data-aos-delay={getAnimationDelay(index) + 150}
                  >
                    {product.brand}
                  </div>
                  <h3
                  ...
                  <div
                    ...
                    data-aos="fade-right"
                    data-aos-delay={getAnimationDelay(index) + 250}
                  >
                    <span className="text-rose-600 font-bold">{formatPrice(product.price)}₫</span>
